...
class BasicSceneGraphEvaluator:
    ...
    def print_stats(self):
        ...
        for k, v in self.result_dict[self.mode + '_recall'].items():
            ...
            print(self.result_dict[self.mode + '_recall_hit'][k])
            print(self.result_dict[self.mode + '_recall_count'][k])
            avg = 0
            for idx in range(50):
            ...
            print('cls avg', avg / 50.0)
            print('total R', float(self.result_dict[self.mode + '_recall_hit'][k][0]) / float(self.result_dict[self.mode + '_recall_count'][k][0] + 1e-10))
    ...
    for k in result_dict[mode + '_recall']:
        ...
        for idx in range(len(match)):
            ...
            if k not in result_dict[mode + '_recall_hit']:
                result_dict[mode + '_recall_hit'][k] = [0] * 51
        ...
        for idx in range(gt_rels.shape[0]):
            ...
            if k not in result_dict[mode + '_recall_count']:
                result_dict[mode + '_recall_count'][k] = [0] * 51
